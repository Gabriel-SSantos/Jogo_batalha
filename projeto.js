...
function ataque(){
      vida2 -= dano
      if(pers1 == 1){
       ação.src = 'https://ggabriel-ss.github.io/Jogo_batalha/fogoataquea.gif'  
      } else if (pers1 == 2){
        ação.src = 'https://ggabriel-ss.github.io/Jogo_batalha/aguaataquea.gif'
      } else if (pers1 == 3){
        ação.src = 'https://ggabriel-ss.github.io/Jogo_batalha/ataqueterraa1.gif'
      } else if(pers1 == 4){
        ação.src = 'https://ggabriel-ss.github.io/Jogo_batalha/araataquea.gif'
      } 
      i++ 
...
let tutor = document.getElementById('tutorial')
function instruções(){
  tutor.innerHTML = `<p class="cjogar">Para selecionar o personagem digite o número correspondente e aperte no botão azul</p><p class="cjogar">Para ver seus atributos passe o mouse sobre o personagem ou mantenha pressionado o dedo sobre ele(se estiver usando celular)</p><p class="cjogar">A ordem dos botões são ATAQUE FRACO, DESCANSO, ATAQUE FORTE, o escudo e a espada aumentam a quantidade de vida e dano respectivamente</p><p class="cjogar">O jogo tem um contador de energia, ataque fraco não gasta energia, descanso acrescenta uma energia extra, e ataque forte precisa de 3 pontos de energia, escudo e espada convertem energia em suas respectivas habilidades (aumento de cura e força)</p><p onclick="fechar()">Fechar</p>`
}
function fechar(){
  tutor.innerHTML = `<p class="cjogar" onclick="instruções()">COMO JOGAR</p>`
}
